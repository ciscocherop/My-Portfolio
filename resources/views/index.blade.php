...
<body data-initial-section="{{ session('success') || $errors->any() ? 'contact' : 'home' }}" class="h-full bg-gray-50 dark:bg-gray-900 text-gray-900 dark:text-gray-100 transition-colors duration-300">
    ...
    <div class="flex min-h-screen flex-col lg:flex-row">
        ...
        <aside id="sidebar"
            class="static w-full lg:w-20 bg-white dark:bg-gray-800 border-b lg:border-r lg:border-b-0 border-gray-200 dark:border-gray-700 flex flex-row lg:flex-col items-center py-2 lg:py-8 px-2 lg:px-0 space-x-2 lg:space-x-0 lg:space-y-8 overflow-x-auto">


            <!-- Dark Mode Toggle -->
            <button id="theme-toggle" class="p-2 lg:p-3 shrink-0 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-700 transition-colors">
                <svg id="theme-icon-sun" class="w-5 h-5 lg:w-6 lg:h-6 hidden dark:block text-orange-500" fill="none"
                    stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                        d="M12 3v1m0 16v1m9-9h-1M4 12H3m15.364 6.364l-.707-.707M6.343 6.343l-.707-.707m12.728 0l-.707.707M6.343 17.657l-.707.707M16 12a4 4 0 11-8 0 4 4 0 018 0z">
                    </path>
                </svg>
                <svg id="theme-icon-moon" class="w-5 h-5 lg:w-6 lg:h-6 block dark:hidden text-orange-500" fill="none"
                    stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
            ...
            <nav class="flex flex-row lg:flex-col space-x-2 lg:space-x-0 lg:space-y-6">
                <button data-section="home"
                    class="nav-link p-2 lg:p-3 shrink-0 rounded-lg hover:bg-orange-100 dark:hover:bg-orange-900/20 transition-colors group flex flex-col items-center">
                    <svg class="w-5 h-5 lg:w-6 lg:h-6 text-gray-600 dark:text-gray-400 group-hover:text-orange-500" fill="none"
                        stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6">
                        </path>
                    </svg>
                    <span class="text-[10px] lg:text-xs mt-1 text-gray-600 dark:text-gray-400 group-hover:text-orange-500 whitespace-nowrap">Home</span>
                </button>
                ...
                <button data-section="about"
                    ...
                    <span class="text-[10px] lg:text-xs mt-1 text-gray-600 dark:text-gray-400 group-hover:text-orange-500 whitespace-nowrap">About</span>
                </button>
                ...
                <button data-section="resume"
                    ...
                    <span
                        class="text-[10px] lg:text-xs mt-1 text-gray-600 dark:text-gray-400 group-hover:text-orange-500 whitespace-nowrap">Resume</span>
                </button>
                ...
                <button data-section="skills"
                    ...
                    <span
                        class="text-[10px] lg:text-xs mt-1 text-gray-600 dark:text-gray-400 group-hover:text-orange-500 whitespace-nowrap">Skills</span>
                </button>
                ...
                <button data-section="contact"
                    ...
                    <span
                        class="text-[10px] lg:text-xs mt-1 text-gray-600 dark:text-gray-400 group-hover:text-orange-500 whitespace-nowrap">Contact</span>
                </button>
       ...
       <div class="flex-1 flex flex-col lg:flex-row">
            ...
            <div
                class="w-full lg:w-96 bg-white dark:bg-gray-800 border-b lg:border-r lg:border-b-0 border-gray-200 dark:border-gray-700 p-4 lg:p-8 flex flex-col items-center lg:justify-center">
                <div class="text-center space-y-3 lg:space-y-6">

                    <!-- Profile Photo -->
                    <div class="relative w-24 h-24 lg:w-44 lg:h-44 mx-auto">
                        <img src="/image/profile.jpeg" alt="Cherop Sisco"
                            class="w-full h-full rounded-full object-cover border-2 lg:border-4 border-orange-500 shadow-lg">
                        <!-- Online indicator -->
                        <span
                    ...
                    <div class="flex flex-wrap justify-center gap-1 lg:gap-2">
                        <span
                            class="px-2 lg:px-3 py-1 bg-orange-100 dark:bg-orange-900/20 text-orange-600 dark:text-orange-400 rounded-full text-[10px] lg:text-xs font-medium">🎓
                            MUBS Student</span>
                        <span
                            class="px-2 lg:px-3 py-1 bg-orange-100 dark:bg-orange-900/20 text-orange-600 dark:text-orange-400 rounded-full text-[10px] lg:text-xs font-medium">💻
                            Laravel Dev</span>
                    ...
                    <div class="flex justify-center space-x-1 lg:space-x-2">
                        ...
                        <a href="https://github.com/ciscocherop" title="GitHub" target="_blank"
                            class="p-2 lg:p-2.5 bg-gray-100 dark:bg-gray-700 hover:bg-orange-100 dark:hover:bg-orange-900/20 rounded-lg transition-colors">
                            <svg class="w-3 h-3 lg:w-4 lg:h-4" fill="currentColor" viewBox="0 0 24 24">
                                <path
                    ...
                    <div class="space-y-2 lg:space-y-3 w-full">
                        <a href="/cv/cherop-sisco-cv.pdf" download
                            class="block w-full px-4 lg:px-6 py-2 lg:py-3 bg-orange-500 hover:bg-orange-600 text-white font-medium rounded-lg transition-colors flex items-center justify-center gap-2 text-sm lg:text-base">
                        ...
                        <button data-section="contact"
                            class="nav-link w-full px-4 lg:px-6 py-2 lg:py-3 border-2 border-orange-500 text-orange-500 hover:bg-orange-50 dark:hover:bg-orange-900/20 font-medium rounded-lg transition-colors flex items-center justify-center gap-2 text-sm lg:text-base">
                            <svg class="w-3 h-3 lg:w-4 lg:h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                    d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z">
                                </path>
            ...
            <div class="flex-1 overflow-y-auto p-4 lg:p-8 xl:p-12">
                    ...
                    <div id="home-section" class="content-section">
                        ...
                        <div class="mb-8">
                            ...
                            <div class="flex items-center gap-2 mt-3">
                                <span class="text-xl text-gray-600 dark:text-gray-300 font-medium">Junior Software Developer</span>
                        ...
                        <p class="text-gray-600 dark:text-gray-300 leading-relaxed text-lg max-w-xl mb-8">
                            ...
                            my engineering skills,through hands-on,real-world projects ,one project at a time.
                        </p>
                    ...
                    <div id="about-section" class="content-section hidden">
                        ...
                        <div
                            ...
                            <p class="text-gray-600 dark:text-gray-300 leading-relaxed">
                                ...
                                <span class="text-orange-500 font-semibold">I enjoy building structured, scalable applications — 
                                    from database-driven
                                     platforms in Laravel to machine learning models deployed for real-world use.
                                     I’m particularly interested in how data and backend architecture power reliable digital systems.
                            </p>
                        </div>
                        ...
                        <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
                            ...
                            <div class="space-y-4">
                                ...
                                <div
                                    ...
                                    <div class="flex gap-3">
                                        <a href="https://www.linkedin.com/in/sisco-cherop-193477294/" target="_blank" rel="noopener noreferrer"
                                        ...
                                        <a href="https://x.com/CiscoCherop" target="_blank" rel="noopener noreferrer"
                                            class="w-10 h-10 bg-orange-100 dark:bg-orange-900/20 rounded-lg flex items-center justify-center hover:bg-orange-500 group transition-colors">
                                            <svg class="w-5 h-5 text-orange-500 group-hover:text-white transition-colors"
                                                fill="currentColor" viewBox="0 0 24 24">
                                                <path
                            ...
                            <div>
                                ...
                                <div
                                    ...
                                    <div>
                                        ...
                                        <input type="text" placeholder="John Doe"
                                            ...
                                            class="w-full px-4 py-3 border border-gray-200 dark:border-gray-600 rounded-lg bg-gray-50 dark:bg-gray-700 text-gray-900 dark:text-white placeholder-gray-400 focus:ring-2 focus:ring-orange-500 focus:border-transparent outline-none transition-all">
                                                        ...
                                                        for="contact-name" class="block text-xs font-medium text-gray-500 dark:text-gray-400 uppercase tracking-wide mb-2">Your
                                        <label
                                                    <input id="contact-name" name="name" type="text" value="{{ old('name') }}" placeholder="John Doe" required maxlength="100"
                                            Address</label>
                                                    @error('name')
                                        ...
                                        <input type="email" placeholder="john@example.com"
                                            class="w-full px-4 py-3 border border-gray-200 dark:border-gray-600 rounded-lg bg-gray-50 dark:bg-gray-700 text-gray-900 dark:text-white placeholder-gray-400 focus:ring-2 focus:ring-orange-500 focus:border-transparent outline-none transition-all">
                                                        ...
                                                        for="contact-email" class="block text-xs font-medium text-gray-500 dark:text-gray-400 uppercase tracking-wide mb-2">Email
                                        <label
                                                    <input id="contact-email" name="email" type="email" value="{{ old('email') }}" placeholder="john@example.com" required maxlength="150"
                                    ...
                                    <div>
                                                        for="contact-subject" class="block text-xs font-medium text-gray-500 dark:text-gray-400 uppercase tracking-wide mb-2">Subject</label>
                                                    <input id="contact-subject" name="subject" type="text" value="{{ old('subject') }}" placeholder="Project collaboration..."
                                    ...
                                    <button type="button"
                                                        for="contact-message" class="block text-xs font-medium text-gray-500 dark:text-gray-400 uppercase tracking-wide mb-2">Message</label>
                                                    <textarea id="contact-message" name="message" rows="4" placeholder="Tell me about your project or idea..." required maxlength="2000"
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                                    @error('message')
                                                        <p class="mt-1 text-sm text-red-600 dark:text-red-400">{{ $message }}</p>
                                                    @enderror
